...
void eicrecon::PseudoPostBurn::init(std::shared_ptr<spdlog::logger> &logger) {

  m_log       = logger;
  
}

void eicrecon::PseudoPostBurn::process(
    const PseudoPostBurn::Input& input,
    const PseudoPostBurn::Output& output) const {
