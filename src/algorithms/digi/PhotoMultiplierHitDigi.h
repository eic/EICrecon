...
public:
    ...
    std::vector<edm4eic::RawPMTHit*> AlgorithmProcess(dd4hep::Detector *detector, std::vector<const edm4hep::SimTrackerHit*>& sim_hits);
...
private:
    ...
    bool Noise_Digits(float noise_rate, int time_windows) const;
};
}
