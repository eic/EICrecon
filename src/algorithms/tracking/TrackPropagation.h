...
public:
  ...
  void process(const std::tuple<const std::vector<const ActsExamples::Trajectories*>,
  ...
  propagate(const ActsExamples::Trajectories*,
  ...
  std::unique_ptr<edm4eic::TrackSegmentCollection> propagateToSurfaceList(
      ...
      bool stopIfTrackPointCutFailed = false) const;
