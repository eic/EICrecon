...
struct OrthogonalTrackSeedingConfig {
  ...
  float deltaRMaxTopSP =
      200. * Acts::UnitConstants::mm; // Max distance in r between middle and top SP in one seed
  ...
  float bFieldMin =
      0.1 *
      Acts::UnitConstants::T; // T (in Acts units of GeV/[e*mm]) - Minimum Magnetic field strength
  float rMinMiddle =
