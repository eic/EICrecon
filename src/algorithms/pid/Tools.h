...
namespace Tools {
  ...
  [[maybe_unused]] static std::unordered_map<int, std::string> GetRadiatorIDs() {
    return std::unordered_map<int, std::string>{{0, "Aerogel"}, {1, "Gas"}};
  }

  [[maybe_unused]] static std::string GetRadiatorName(int id) {
    std::string name;
    try {
  ...
  [[maybe_unused]] static int GetRadiatorID(std::string name) {
  ...
  [[maybe_unused]] static std::vector<std::pair<double, double>>
