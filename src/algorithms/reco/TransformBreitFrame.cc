...
void TransformBreitFrame::process(const TransformBreitFrame::Input& input,
  ...
  m_log->debug("scattered electron in lab frame px,py,pz,E = {},{},{},{}", e_final.Px(),
               e_final.Py(), e_final.Pz(), e_final.E());

  // Set up the transformation
  const PxPyPzEVector virtual_photon = (e_initial - e_final);
  m_log->debug("virtual photon in lab frame px,py,pz,E = {},{},{},{}", virtual_photon.Px(),
  ...
  m_log->debug("incoming hadron in Breit frame px,py,pz,E = {},{},{},{}", p_initial_breit.Px(),
               p_initial_breit.Py(), p_initial_breit.Pz(), p_initial_breit.E());
  m_log->debug("virtual photon in Breit frame px,py,pz,E = {},{},{},{}", virtual_photon_breit.Px(),
