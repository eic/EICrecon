...
struct ImagingTopoClusterConfig {
  ...
  std::vector<std::variant<std::string, double>> sameLayerDistXYZ = {
      1.0 * dd4hep::mm, 1.0 * dd4hep::mm, 20.0 * dd4hep::mm};
  ...
  std::vector<std::variant<std::string, double>> diffLayerDistXYZ = {
      1.0 * dd4hep::mm, 1.0 * dd4hep::mm, 20.0 * dd4hep::mm};
