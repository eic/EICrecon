...
##       SIM.action.mapActions['tpc'] = "TPCSDAction"
##     
SIM.action.mapActions = {'DRICH': 'Geant4OpticalTrackerAction', 'MRICH': 'Geant4OpticalTrackerAction', 'PFRICH': 'Geant4OpticalTrackerAction', 'DIRC': 'Geant4OpticalTrackerAction'}
...
SIM.filter.filters = {'geantino': {'name': 'GeantinoRejectFilter/GeantinoRejector', 'parameter': {}}, 'edep1kev': {'name': 'EnergyDepositMinimumCut', 'parameter': {'Cut': 0.001}}, 'edep0': {'name': 'EnergyDepositMinimumCut/Cut0', 'parameter': {'Cut': 0.0}}, 'opticalphotons': {'name': 'ParticleSelectFilter/OpticalPhotonSelector', 'parameter': {'particle': 'opticalphoton'}}}

##  a map between patterns and filter objects, using patterns to attach filters to sensitive detector 
SIM.filter.mapDetFilter = {'DRICH': 'opticalphotons', 'MRICH': 'opticalphotons', 'PFRICH': 'opticalphotons', 'DIRC': 'opticalphotons'}
...
# SIM.gun.direction = (0, 0, 1) #was originally NOT commented
...
SIM.gun.momentumMin = 1000.0 #0.0
...
SIM.gun.thetaMax = 3.1049654711 #None, this is in radians
SIM.gun.thetaMin = 0.03662718246 #None
