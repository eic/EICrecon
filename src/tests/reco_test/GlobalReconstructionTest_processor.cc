...
void GlobalReconstructionTest_processor::Process(const std::shared_ptr<const JEvent>& event) {
  ...
  m_log->debug("----------- GlobalReconstructionTest_processor {}-----------",
...
void GlobalReconstructionTest_processor::printRecoParticles(
    std::vector<const edm4eic::ReconstructedParticle*> reco_particles, const std::string& title) {
