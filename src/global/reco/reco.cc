...
void InitPlugin(JApplication* app) {
  ...
  app->Add(new JOmniFactoryGeneratorT<FarForwardNeutralsReconstruction_factory>(
      "ReconstructedHcalFarForwardZDCNeutrals", {"HcalFarForwardZDCClusters"},
      {"ReconstructedHcalFarForwardZDCNeutrals"},
      {.offsetPositionName            = "HcalFarForwardZDC_SiPMonTile_r_pos",
       .neutronScaleCorrCoeff         = {2.4, 0.89},
       .gammaScaleCorrCoeff           = {1.1, 0.98},
  ...
  app->Add(new JOmniFactoryGeneratorT<FarForwardNeutralsReconstruction_factory>(
      "ReconstructedB0EcalNeutrals", {"B0ECalClusters"}, {"ReconstructedB0EcalNeutrals"},
      {.offsetPositionName            = "HcalFarForwardZDC_SiPMonTile_r_pos",
       .neutronScaleCorrCoeff         = {0., 0.},
       .gammaScaleCorrCoeff           = {0.99, 1.14},
       .canDetectGammas               = true,
  ...
  app->Add(new JOmniFactoryGeneratorT<FarForwardNeutralsReconstruction_factory>(
      "ReconstructedEcalEndcapPNeutrals", {"EcalEndcapPClusters"},
      {"ReconstructedEcalEndcapPNeutrals"},
      {.offsetPositionName            = "HcalFarForwardZDC_SiPMonTile_r_pos",
       .neutronScaleCorrCoeff         = {0., 0.},
       .gammaScaleCorrCoeff           = {1.05, 1.01},
       .canDetectGammas               = true,
       .canDetectNeutrons             = false,
       .gammaMode                     = "LeaderOnly",
       .neutronMode                   = "None",
  ...
  app->Add(new JOmniFactoryGeneratorT<FarForwardNeutralsReconstruction_factory>(
      "ReconstructedLFHCALNeutrals", {"LFHCALClusters"}, {"ReconstructedLFHCALNeutrals"},
      {.offsetPositionName            = "HcalFarForwardZDC_SiPMonTile_r_pos",
       .neutronScaleCorrCoeff         = {2.55, 0.95},
       .gammaScaleCorrCoeff           = {0., 0.},
       .canDetectGammas               = false,
       .canDetectNeutrons             = true,
       .gammaMode                     = "None",
       .neutronMode                   = "LeaderOnly",
       .clusterEmin                   = 7.0,
       .associateAllClustersToNeutron = false,
       .globalToProtonRotation        = -0.025,
       .gammaZMaxOffset               = 400,
