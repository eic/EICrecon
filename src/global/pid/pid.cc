  ...
  // clang-format off
    ...
    app->Add(new JOmniFactoryGeneratorT<ParticlesWithPID_factory>(
          "ChargedParticlesWithAssociations",
          {
            ...
            "CentralCKFTracksUnfiltered",                 // edm4eic::Track
            "DRICHMergedIrtCherenkovParticleID" // edm4eic::CherenkovParticleID
          },
          {
            "ReconstructedChargedParticlesUnfiltered",            // edm4eic::ReconstructedParticle
            "ReconstructedChargedParticleAssociationsUnfiltered", // edm4eic::MCRecoParticleAssociation
            "ReconstructedChargedParticleIDsUnfiltered"           // edm4hep::ParticleID
          },
          link_cfg,
          app
          ));
    ...
    app->Add(new JOmniFactoryGeneratorT<ParticlesWithPID_factory>(
          ...
          {
            "MCParticles",                      // edm4hep::MCParticle
            "CentralCKFSeededTracksUnfiltered",           // edm4eic::Track
            "DRICHMergedIrtCherenkovParticleID" // edm4eic::CherenkovParticleID
          },
          {
            "ReconstructedSeededChargedParticlesUnfiltered",            // edm4eic::ReconstructedParticle
            "ReconstructedSeededChargedParticleAssociationsUnfiltered", // edm4eic::MCRecoParticleAssociation
            "ReconstructedSeededChargedParticleIDsUnfiltered"           // edm4hep::ParticleID
          },
          link_cfg,
          app
          ));
    ...
    app->Add(new JOmniFactoryGeneratorT<ParticlesWithPID_factory>(
          "FilteredChargedParticlesWithAssociations",
          {
            "MCParticles",                      // edm4hep::MCParticle
