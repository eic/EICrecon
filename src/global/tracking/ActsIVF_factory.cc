...
void eicrecon::ActsIVF_factory::Init() {
    ...
    app->SetDefaultParameter(param_prefix + ":maxVertices", cfg.m_maxVertices, "Maximum num vertices that can be found");
    app->SetDefaultParameter(param_prefix + ":reassignTracksAfterFirstFit", cfg.m_reassignTracksAfterFirstFit, "Whether or not to reassign tracks after first fit");
