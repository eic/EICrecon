...
void InitPlugin(JApplication* app) {
  ...
  PIDLookupConfig drich_pid_cfg{
      ...
      .charge_values            = {1},
      .momentum_edges           = {0.75, 1.25, 1.75, 2.25, 2.75, 3.25, 3.75, 4.25, 4.75, 5.25, 5.75, 6.25, 
                                    ...
                                    27.25, 27.75, 28.25, 28.75, 29.25, 29.75, 30.25, 30.75, 31.25, 33.00, 
                                    35.00, 37.00, 39.00, 41.00, 43.00, 45.00, 47.00, 49.00, 51.00, 59.00, 
                                    61.00},
  
      .polar_edges              = {0.0635, 0.0702, 0.0776, 0.0858, 0.0948, 0.1047, 0.1157, 0.1278, 0.1412,
                                    0.1560, 0.1724, 0.1904, 0.2103, 0.2322, 0.2564, 0.2830, 0.3123, 0.3445, 
                                    0.3799, 0.4188},
