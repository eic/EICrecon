...
void InitPlugin_digiMPGD(JApplication* app) {
  ...
  if ((SiFactoryPattern & 0x2) != 0U) {
    app->Add(new JOmniFactoryGeneratorT<SiliconTrackerDigi_factory>(
        JOmniFactoryGeneratorT<SiliconTrackerDigi_factory>::TypedWiring{
            ...
            .m_default_output_tags  = {"OuterMPGDBarrelRawHits_TK", "OuterMPGDBarrelRawHitAssociations_TK"},
            .m_default_cfg = {
                .threshold      = 100 * dd4hep::eV,
                .timeResolution = 10,
            },
  ...
  app->Add(new JOmniFactoryGeneratorT<SiliconTrackerDigi_factory>(
      JOmniFactoryGeneratorT<SiliconTrackerDigi_factory>::TypedWiring{
          ...
          .m_default_output_tags  = {"BackwardMPGDEndcapRawHits_TK", "BackwardMPGDEndcapRawHitAssociations_TK"},
          .m_default_cfg = {
              .threshold      = 100 * dd4hep::eV,
              .timeResolution = 10,
          },
  ...
  app->Add(new JOmniFactoryGeneratorT<SiliconTrackerDigi_factory>(
      JOmniFactoryGeneratorT<SiliconTrackerDigi_factory>::TypedWiring{
          ...
          .m_default_output_tags  = {"ForwardMPGDEndcapRawHits_TK", "ForwardMPGDEndcapRawHitAssociations_TK"},
          .m_default_cfg = {
              .threshold      = 100 * dd4hep::eV,
              .timeResolution = 10,
          },
