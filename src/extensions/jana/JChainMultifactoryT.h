...
template <typename ConfigT = eicrecon::NoConfig> class JChainMultifactoryT : public JMultifactory {
public:
  using ConfigType = ConfigT;

  /// Constructor with NoConfig
  JChainMultifactoryT(std::string tag, std::vector<std::string> input_tags,
                      std::vector<std::string> output_tags, ConfigT cfg)
      : m_tag(std::move(tag))
  ...
  explicit JChainMultifactoryT(std::string tag, std::vector<std::string> input_tags,
