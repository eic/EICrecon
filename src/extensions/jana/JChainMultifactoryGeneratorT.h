...
template <class FactoryT> class JChainMultifactoryGeneratorT : public JFactoryGenerator {
...
public:
  ...
  explicit JChainMultifactoryGeneratorT(std::string tag,
                                        std::vector<std::string> default_input_tags,
                                        std::vector<std::string> output_tags, FactoryConfigType cfg,
                                        JApplication* app)
      : m_tag(tag)
  ...
  explicit JChainMultifactoryGeneratorT(std::string tag,
                                        std::vector<std::string> default_input_tags,
                                        std::vector<std::string> output_tags, JApplication* app)
      : m_tag(tag)
      , m_default_input_tags(std::move(default_input_tags))
      , m_default_output_tags(std::move(output_tags))
      , m_app(app){};
