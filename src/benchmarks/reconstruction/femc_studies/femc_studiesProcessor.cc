...
void femc_studiesProcessor::Init() {
  ...
  hClusterESimcalib_E_phi =
      new TH3D("hClusterESimcalib_E_phi", "; E_{MC} (GeV); E_{rec,sim hit}/E_{MC}; #varphi (rad)",
               1500, 0., 150.0, 200, 0., 2.0, 360, -TMath::Pi(), TMath::Pi());
  hCellESim_layerX = new TH2D("hCellESim_layerX", "; #cell ID X; E_{rec,sim hit} (GeV)", 500, -0.5,
                              499.5, 5000, 0, 1);
  hCellESim_layerY = new TH2D("hCellESim_layerY", "; #cell ID Y; E_{rec,sim hit} (GeV)", 500, -0.5,
                              499.5, 5000, 0, 1);
  hCellTSim_layerX = new TH2D("hCellTSim_layerX", "; #cell ID X; t_{rec,sim hit} (GeV)", 500, -0.5,
                              499.5, 5000, 0, 1000);
  hPosCaloSimHitsXY =
  ...
  if (enableTree) {
    ...
    event_tree->Branch("tower_FEMC_clusIDA", t_fEMC_towers_clusterIDA,
                       "tower_FEMC_clusIDA[tower_FEMC_N]/S");
    event_tree->Branch("tower_FEMC_clusIDB", t_fEMC_towers_clusterIDB,
                       "tower_FEMC_clusIDB[tower_FEMC_N]/S");
    event_tree->Branch("tower_FEMC_trueID", t_fEMC_towers_cellTrueID,
  ...
  if (enableTreeCluster) {
    ...
    cluster_tree->Branch("cluster_FEMC_Ncells", t_fEMC_cluster_NCells,
                         "cluster_FEMC_Ncells[cluster_FEMC_N]/I");
    cluster_tree->Branch("cluster_FEMC_Eta", t_fEMC_cluster_Eta,
                         "cluster_FEMC_Eta[cluster_FEMC_N]/F");
    cluster_tree->Branch("cluster_FEMC_Phi", t_fEMC_cluster_Phi,
