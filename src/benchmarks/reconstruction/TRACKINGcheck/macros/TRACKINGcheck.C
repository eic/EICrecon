...
void EEMCcheck(void)
{
    ...
    auto EcalEndcapNRawhits_hits_per_event  = (TH1I*)fil->Get("EEMC/EcalEndcapNRawhits_hits_per_event");
    ...
    auto EcalEndcapNRechits_hits_per_event  = (TH1I*)fil->Get("EEMC/EcalEndcapNRechits_hits_per_event");
    ...
    auto EcalEndcapNIslandProtoClusters_clusters_per_event  = (TH1I*)fil->Get("EEMC/EcalEndcapNIslandProtoClusters_clusters_per_event");
    auto EcalEndcapNIslandProtoClusters_hits_per_cluster  = (TH1I*)fil->Get("EEMC/EcalEndcapNIslandProtoClusters_hits_per_cluster");
