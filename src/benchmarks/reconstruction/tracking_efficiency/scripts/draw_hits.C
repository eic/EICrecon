...
void draw_hits() {
  ...
  TH2D* hitsxy_barrel_si =
      new TH2D("hitsxy_barrel_si", "hitsxy_barrel_si", nbins, -x, x, nbins, -y, y);
  TH2D* hitsxy_barrel_mm_in =
      new TH2D("hitsxy_barrel_mm_in", "hitsxy_barrel_mm_in", nbins, -x, x, nbins, -y, y);
  TH2D* hitsxy_barrel_tof =
      new TH2D("hitsxy_barrel_tof", "hitsxy_barrel_tof", nbins, -x, x, nbins, -y, y);
  TH2D* hitsxy_barrel_mm_out =
      new TH2D("hitsxy_barrel_mm_out", "hitsxy_barrel_mm_out", nbins, -x, x, nbins, -y, y);

  TString si_vtx_hitsXY =
      "VertexBarrelHits.position.y*0.1:VertexBarrelHits.position.x*0.1>>hitsxy_vtx_si";
  TString si_barrel_hitsXY =
      "SiBarrelHits.position.y*0.1:SiBarrelHits.position.x*0.1>>hitsxy_barrel_si";
  TString barrel_mpgd_in_hitsXY =
      "MPGDBarrelHits.position.y*0.1:MPGDBarrelHits.position.x*0.1>>hitsxy_barrel_mm_in";
  TString tof_barrel_hitsXY =
      "TOFBarrelHits.position.y*0.1:TOFBarrelHits.position.x*0.1>>hitsxy_barrel_tof";
  TString barrel_mpgd_out_hitsXY =
      "OuterMPGDBarrelHits.position.y*0.1:OuterMPGDBarrelHits.position.x*0.1>>hitsxy_barrel_mm_out";
  ...
  hitsxy_barrel_tof->SetLineColor(kGreen);
  hitsxy_barrel_mm_out->SetMarkerStyle(20);
  ...
  TH2D* hitsrz_barrel_si =
      new TH2D("hitsrz_barrel_si", "hitsrz_barrel_si", nbinsx, -x, x, nbinsy, -y, y);
  TH2D* hitsrz_barrel_mm_in =
      new TH2D("hitsrz_barrel_mm_in", "hitsrz_barrel_mm_in", nbinsx, -x, x, nbinsy, -y, y);
  TH2D* hitsrz_barrel_mm_out =
      new TH2D("hitsrz_barrel_mm_out", "hitsrz_barrel_mm_out", nbinsx, -x, x, nbinsy, -y, y);
  TH2D* hitsrz_barrel_tof =
      new TH2D("hitsrz_barrel_tof", "hitsrz_barrel_tof", nbinsx, -x, x, nbinsy, -y, y);
  TH2D* hitsrz_disks_si =
      new TH2D("hitsrz_disks_si", "hitsrz_disks_si", nbinsx, -x, x, nbinsy, -y, y);
  TH2D* hitsrz_endcap_tof =
      new TH2D("hitsrz_endcap_tof", "hitsrz_endcap_tof", nbinsx, -x, x, nbinsy, -y, y);
  TH2D* hitsrz_fwd_mpgd =
      new TH2D("hitsrz_fwd_mpgd", "hitsrz_fwd_mpgd", nbinsx, -x, x, nbinsy, -y, y);
  TH2D* hitsrz_bwd_mpgd =
      new TH2D("hitsrz_bwd_mpgd", "hitsrz_bwd_mpgd", nbinsx, -x, x, nbinsy, -y, y);

  TH2D* hitsrz_vtx_si_1 =
      new TH2D("hitsrz_vtx_si_1", "hitsrz_vtx_si_1", nbinsx, xmin, x, nbinsy, -y, y);
  TH2D* hitsrz_barrel_si_1 =
      new TH2D("hitsrz_barrel_si_1", "hitsrz_barrel_si_1", nbinsx, -x, x, nbinsy, -y, y);
  TH2D* hitsrz_barrel_mm_in_1 =
      new TH2D("hitsrz_barrel_mm_in_1", "hitsrz_barrel_mm_in_1", nbinsx, -x, x, nbinsy, -y, y);
  TH2D* hitsrz_barrel_mm_out_1 =
      new TH2D("hitsrz_barrel_mm_out_1", "hitsrz_barrel_mm_out_1", nbinsx, -x, x, nbinsy, -y, y);
  TH2D* hitsrz_barrel_tof_1 =
      new TH2D("hitsrz_barrel_tof_1", "hitsrz_barrel_tof_1", nbinsx, -x, x, nbinsy, -y, y);
  TH2D* hitsrz_disks_si_1 =
      new TH2D("hitsrz_disks_si_1", "hitsrz_disks_si_1", nbinsx, -x, x, nbinsy, -y, y);
  TH2D* hitsrz_endcap_tof_1 =
      new TH2D("hitsrz_endcap_tof_1", "hitsrz_endcap_tof_1", nbinsx, -x, x, nbinsy, -y, y);
  TH2D* hitsrz_fwd_mpgd_1 =
      new TH2D("hitsrz_fwd_mpgd_1", "hitsrz_fwd_mpgd_1", nbinsx, -x, x, nbinsy, -y, y);
  TH2D* hitsrz_bwd_mpgd_1 =
      new TH2D("hitsrz_bwd_mpgd_1", "hitsrz_bwd_mpgd_1", nbinsx, -x, x, nbinsy, -y, y);

  TString si_vtx_hitsrz_posR =
      "sqrt(VertexBarrelHits.position.x*VertexBarrelHits.position.x+VertexBarrelHits.position.y*"
      "VertexBarrelHits.position.y)*0.1:VertexBarrelHits.position.z*0.1>>hitsrz_vtx_si";

  TString si_barrel_hitsrz_posR =
      "sqrt(SiBarrelHits.position.x*SiBarrelHits.position.x+SiBarrelHits.position.y*SiBarrelHits."
      "position.y)*0.1:SiBarrelHits.position.z*0.1>>hitsrz_barrel_si";

  TString barrel_mpgd_in_hitsrz_posR =
      "sqrt(MPGDBarrelHits.position.x*MPGDBarrelHits.position.x+MPGDBarrelHits.position.y*"
      "MPGDBarrelHits.position.y)*0.1:MPGDBarrelHits.position.z*0.1>>hitsrz_barrel_mm_in";

  TString tof_barrel_hitsrz_posR =
      "sqrt(TOFBarrelHits.position.x*TOFBarrelHits.position.x+TOFBarrelHits.position.y*"
      "TOFBarrelHits.position.y)*0.1:TOFBarrelHits.position.z*0.1>>hitsrz_barrel_tof";

  TString barrel_mpgd_out_hitsrz_posR =
      "sqrt(OuterMPGDBarrelHits.position.x*OuterMPGDBarrelHits.position.x+OuterMPGDBarrelHits."
      "position.y*OuterMPGDBarrelHits.position.y)*0.1:OuterMPGDBarrelHits.position.z*0.1>>hitsrz_"
      "barrel_mm_out";

  TString disks_si_hitsrz_posR =
      "sqrt(TrackerEndcapHits.position.x*TrackerEndcapHits.position.x+TrackerEndcapHits.position.y*"
      "TrackerEndcapHits.position.y)*0.1:TrackerEndcapHits.position.z*0.1>>hitsrz_disks_si";

  TString endcap_tof_hitsrz_posR =
      "sqrt(TOFEndcapHits.position.x*TOFEndcapHits.position.x+TOFEndcapHits.position.y*"
      "TOFEndcapHits.position.y)*0.1:TOFEndcapHits.position.z*0.1>>hitsrz_endcap_tof";

  TString fwd_mpgd_hitsrz_posR =
      "sqrt(ForwardMPGDEndcapHits.position.x*ForwardMPGDEndcapHits.position.x+"
      "ForwardMPGDEndcapHits.position.y*ForwardMPGDEndcapHits.position.y)*0.1:"
      "ForwardMPGDEndcapHits.position.z*0.1>>hitsrz_fwd_mpgd";

  TString bwd_mpgd_hitsrz_posR =
      "sqrt(BackwardMPGDEndcapHits.position.x*BackwardMPGDEndcapHits.position.x+"
      "BackwardMPGDEndcapHits.position.y*BackwardMPGDEndcapHits.position.y)*0.1:"
      "BackwardMPGDEndcapHits.position.z*0.1>>hitsrz_bwd_mpgd";

  sim->Draw(si_vtx_hitsrz_posR.Data(), "VertexBarrelHits.position.y>0",
            ""); // Multiply by 0.1 for cm
  ...
  TString si_vtx_hitsrz_negR =
      "-1.0*sqrt(VertexBarrelHits.position.x*VertexBarrelHits.position.x+VertexBarrelHits.position."
      "y*VertexBarrelHits.position.y)*0.1:VertexBarrelHits.position.z*0.1>>hitsrz_vtx_si_1";

  TString si_barrel_hitsrz_negR =
      "-1.0*sqrt(SiBarrelHits.position.x*SiBarrelHits.position.x+SiBarrelHits.position.y*"
      "SiBarrelHits.position.y)*0.1:SiBarrelHits.position.z*0.1>>hitsrz_barrel_si_1";

  TString barrel_mpgd_in_hitsrz_negR =
      "-1.0*sqrt(MPGDBarrelHits.position.x*MPGDBarrelHits.position.x+MPGDBarrelHits.position.y*"
      "MPGDBarrelHits.position.y)*0.1:MPGDBarrelHits.position.z*0.1>>hitsrz_barrel_mm_in_1";

  TString tof_barrel_hitsrz_negR =
      "-1.0*sqrt(TOFBarrelHits.position.x*TOFBarrelHits.position.x+TOFBarrelHits.position.y*"
      "TOFBarrelHits.position.y)*0.1:TOFBarrelHits.position.z*0.1>>hitsrz_barrel_tof_1";

  TString barrel_mpgd_out_hitsrz_negR =
      "-1.0*sqrt(OuterMPGDBarrelHits.position.x*OuterMPGDBarrelHits.position.x+OuterMPGDBarrelHits."
      "position.y*OuterMPGDBarrelHits.position.y)*0.1:OuterMPGDBarrelHits.position.z*0.1>>hitsrz_"
      "barrel_mm_out_1";

  TString disks_si_hitsrz_negR =
      "-1.0*sqrt(TrackerEndcapHits.position.x*TrackerEndcapHits.position.x+TrackerEndcapHits."
      "position.y*TrackerEndcapHits.position.y)*0.1:TrackerEndcapHits.position.z*0.1>>hitsrz_disks_"
      "si_1";

  TString endcap_tof_hitsrz_negR =
      "-1.0*sqrt(TOFEndcapHits.position.x*TOFEndcapHits.position.x+TOFEndcapHits.position.y*"
      "TOFEndcapHits.position.y)*0.1:TOFEndcapHits.position.z*0.1>>hitsrz_endcap_tof_1";

  TString fwd_mpgd_hitsrz_negR =
      "-1.0*sqrt(ForwardMPGDEndcapHits.position.x*ForwardMPGDEndcapHits.position.x+"
      "ForwardMPGDEndcapHits.position.y*ForwardMPGDEndcapHits.position.y)*0.1:"
      "ForwardMPGDEndcapHits.position.z*0.1>>hitsrz_fwd_mpgd_1";

  TString bwd_mpgd_hitsrz_negR =
      "-1.0*sqrt(BackwardMPGDEndcapHits.position.x*BackwardMPGDEndcapHits.position.x+"
      "BackwardMPGDEndcapHits.position.y*BackwardMPGDEndcapHits.position.y)*0.1:"
      "BackwardMPGDEndcapHits.position.z*0.1>>hitsrz_bwd_mpgd_1";

  sim->Draw(si_vtx_hitsrz_negR.Data(), "VertexBarrelHits.position.y<0",
            ""); // Multiply by 0.1 for cm
