...
void Plot_eta() {
  ...
  TH1D* hits_barrel_mpgd_in =
      new TH1D("hits_barrel_mpgd_in", "hits_barrel_mpgd_in", 200, -4., 4.); // BMT1
  ...
  TH1D* hits_barrel_mpgd_out =
      new TH1D("hits_barrel_mpgd_out", "hits_barrel_mpgd_out", 200, -4., 4.);
  ...
  TString vtx_hits_eta    = "-TMath::Log(TMath::Tan((TMath::ATan2(sqrt(VertexBarrelHits.position.x*"
                            "VertexBarrelHits.position.x+VertexBarrelHits.position.y*VertexBarrelHits."
                            "position.y),VertexBarrelHits.position.z))/2))>>hits_vtx_si";
  TString Barrel_hits_eta = "-TMath::Log(TMath::Tan((TMath::ATan2(sqrt(SiBarrelHits.position.x*"
                            "SiBarrelHits.position.x+SiBarrelHits.position.y*SiBarrelHits.position."
                            "y),SiBarrelHits.position.z))/2))>>hits_barrel_si";
  TString BMM_hits_eta    = "-TMath::Log(TMath::Tan((TMath::ATan2(sqrt(MPGDBarrelHits.position.x*"
                            "MPGDBarrelHits.position.x+MPGDBarrelHits.position.y*MPGDBarrelHits."
                            "position.y),MPGDBarrelHits.position.z))/2))>>hits_barrel_mpgd_in";
  TString ToF_hits_eta    = "-TMath::Log(TMath::Tan((TMath::ATan2(sqrt(TOFBarrelHits.position.x*"
                            "TOFBarrelHits.position.x+TOFBarrelHits.position.y*TOFBarrelHits.position."
                            "y),TOFBarrelHits.position.z))/2))>>hits_barrel_tof";
  TString ETracker_hits_eta =
      "-TMath::Log(TMath::Tan((TMath::ATan2(sqrt(TrackerEndcapHits.position.x*TrackerEndcapHits."
      "position.x+TrackerEndcapHits.position.y*TrackerEndcapHits.position.y),TrackerEndcapHits."
      "position.z))/2))>>hits_disks_si";
  TString ETOF_hits_eta = "-TMath::Log(TMath::Tan((TMath::ATan2(sqrt(TOFEndcapHits.position.x*"
                          "TOFEndcapHits.position.x+TOFEndcapHits.position.y*TOFEndcapHits."
                          "position.y),TOFEndcapHits.position.z))/2))>>hits_endcap_tof";
  TString OutBMM_hits_eta =
      "-TMath::Log(TMath::Tan((TMath::ATan2(sqrt(OuterMPGDBarrelHits.position.x*"
      "OuterMPGDBarrelHits.position.x+OuterMPGDBarrelHits.position.y*OuterMPGDBarrelHits.position."
      "y),OuterMPGDBarrelHits.position.z))/2))>>hits_barrel_mpgd_out";
  TString FwdMM_hits_eta =
      "-TMath::Log(TMath::Tan((TMath::ATan2(sqrt(ForwardMPGDEndcapHits.position.x*"
      "ForwardMPGDEndcapHits.position.x+ForwardMPGDEndcapHits.position.y*ForwardMPGDEndcapHits."
      "position.y),ForwardMPGDEndcapHits.position.z))/2))>>hits_fwd_mpgd";
  TString BwdMM_hits_eta =
      "-TMath::Log(TMath::Tan((TMath::ATan2(sqrt(BackwardMPGDEndcapHits.position.x*"
      "BackwardMPGDEndcapHits.position.x+BackwardMPGDEndcapHits.position.y*BackwardMPGDEndcapHits."
      "position.y),BackwardMPGDEndcapHits.position.z))/2))>>hits_bwd_mpgd";
  TString B0_hits_eta = "-TMath::Log(TMath::Tan((TMath::ATan2(sqrt(B0TrackerHits.position.x*"
                        "B0TrackerHits.position.x+B0TrackerHits.position.y*B0TrackerHits.position."
                        "y),B0TrackerHits.position.z))/2))>>hits_b0tracker";
