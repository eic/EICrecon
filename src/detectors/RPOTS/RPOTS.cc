...
void InitPlugin(JApplication* app) {
  ...
  app->Add(new JOmniFactoryGeneratorT<SiliconTrackerDigi_factory>(
      "ForwardRomanPotRawHits", {"ForwardRomanPotHits"}, {"ForwardRomanPotRawHits"},
      {
  ...
  recon_cfg.aX = {{2.102403743, 29.11067626}, {0.186640381, 0.192604619}};
  recon_cfg.aY = {{0.0000159900, 3.94082098}, {0.0000079946, -0.1402995}};
  ...
  recon_cfg.nomMomentum =
      275.0; // in GEV --> exactly half of the top energy momentum (for proton spectators from deuteron breakup)
  ...
  app->Add(new JOmniFactoryGeneratorT<MatrixTransferStatic_factory>(
      "ForwardRomanPotRecParticles", {"MCParticles", "ForwardRomanPotRecHits"},
      {"ForwardRomanPotRecParticles"}, recon_cfg, app));
}
}
