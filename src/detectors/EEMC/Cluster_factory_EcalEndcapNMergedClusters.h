...
class Association_factory_EcalEndcapNMergedClusterAssociations : public JFactoryPodioT<edm4eic::MCRecoClusterParticleAssociation> {
...
class Cluster_factory_EcalEndcapNMergedClusters : public JFactoryPodioT<edm4eic::Cluster>, CalorimeterClusterMerger {
