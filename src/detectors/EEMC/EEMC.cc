...
#include "TruthCluster_factory_EcalEndcapPInsertTruthProtoClusters.h"
...
extern "C" {
    void InitPlugin(JApplication *app) {
        ...
        app->Add(new JFactoryGeneratorT<TruthCluster_factory_EcalEndcapPInsertTruthProtoClusters>());
    }
}
