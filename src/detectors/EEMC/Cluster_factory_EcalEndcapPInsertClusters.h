...
class Association_factory_EcalEndcapPInsertClusterAssociations : public JFactoryPodioT<edm4eic::MCRecoClusterParticleAssociation> {
...
class Cluster_factory_EcalEndcapPInsertClusters : public JFactoryPodioT<edm4eic::Cluster>, CalorimeterClusterRecoCoG {
