...
class Association_factory_EcalEndcapPTruthClusterAssociations : public JFactoryPodioT<edm4eic::MCRecoClusterParticleAssociation> {
...
class Cluster_factory_EcalEndcapPTruthClusters : public JFactoryPodioT<edm4eic::Cluster>, CalorimeterClusterRecoCoG {
