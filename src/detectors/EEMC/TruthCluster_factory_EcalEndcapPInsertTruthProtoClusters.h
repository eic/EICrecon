...
class TruthCluster_factory_EcalEndcapPInsertTruthProtoClusters : public JFactoryT<edm4eic::ProtoCluster>, CalorimeterTruthClustering {
...
public:
    ...
    void Init() override{
        ...
        m_inputHit_tag = "EcalEndcapPInsertTruthProtoClusters";
