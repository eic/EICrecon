...
class ProtoCluster_factory_EcalEndcapPInsertIslandProtoClusters : public JFactoryPodioTFixed<edm4eic::ProtoCluster>, CalorimeterIslandCluster {
...
public:
    ...
    void Init() override{
        ...
        app->SetDefaultParameter("EEMC:EcalEndcapPInsertIslandProtoClusters:adjacencyMatrix", u_adjacencyMatrix);
