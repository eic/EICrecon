...
class Association_factory_EcalEndcapPInsertTruthClusterAssociations : public JFactoryPodioT<edm4eic::MCRecoClusterParticleAssociation> {
...
class Cluster_factory_EcalEndcapPInsertTruthClusters : public JFactoryPodioT<edm4eic::Cluster>, CalorimeterClusterRecoCoG {
