...
class Association_factory_EcalEndcapNTruthClusterAssociations : public JFactoryPodioTFixed<edm4eic::MCRecoClusterParticleAssociation> {
...
class Cluster_factory_EcalEndcapNTruthClusters : public JFactoryPodioTFixed<edm4eic::Cluster>, CalorimeterClusterRecoCoG {
