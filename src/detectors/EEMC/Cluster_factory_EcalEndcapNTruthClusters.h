...
class Association_factory_EcalEndcapNTruthClusterAssociations : public JFactoryPodioT<edm4eic::MCRecoClusterParticleAssociation> {
...
class Cluster_factory_EcalEndcapNTruthClusters : public JFactoryPodioT<edm4eic::Cluster>, CalorimeterClusterRecoCoG {
