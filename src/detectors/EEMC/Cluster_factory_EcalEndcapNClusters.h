...
class Association_factory_EcalEndcapNClusterAssociations : public JFactoryPodioT<edm4eic::MCRecoClusterParticleAssociation> {
...
class Cluster_factory_EcalEndcapNClusters : public JFactoryPodioT<edm4eic::Cluster>, CalorimeterClusterRecoCoG {
