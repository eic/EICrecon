...
class Association_factory_EcalEndcapPClusterAssociations : public JFactoryPodioT<edm4eic::MCRecoClusterParticleAssociation> {
...
class Cluster_factory_EcalEndcapPClusters : public JFactoryPodioT<edm4eic::Cluster>, CalorimeterClusterRecoCoG {
