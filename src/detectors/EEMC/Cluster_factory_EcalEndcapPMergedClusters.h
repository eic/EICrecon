...
class Association_factory_EcalEndcapPMergedClusterAssociations : public JFactoryPodioT<edm4eic::MCRecoClusterParticleAssociation> {
...
class Cluster_factory_EcalEndcapPMergedClusters : public JFactoryPodioT<edm4eic::Cluster>, CalorimeterClusterMerger {
