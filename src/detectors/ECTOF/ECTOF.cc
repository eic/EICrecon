...
void InitPlugin(JApplication* app) {
  ...
  if (split_timeframes) {
    ...
    app->Add(new JOmniFactoryGeneratorT<TrackerHitReconstruction_factory>(
        "TOFEndcapRecHits", {"TOFEndcapRawHits"}, {"TOFEndcapRecHits"},
        {.timeResolution = 0.025}, app, JEventLevel::Timeslice));
  }
  ...
  app->Add(new JOmniFactoryGeneratorT<LGADHitClustering_factory>(
      ...
      {split_timeframes ? "TOFEndcapRecHits" : "TOFEndcapSharedRecHits"},
