...
void InitPlugin(JApplication *app) {
    ...
    app->Add(new JChainFactoryGeneratorT<SiliconTrackerDigi_factory>({"TOFBarrelHits"}, "TOFBarrelDigiHits", digi_default_cfg));
    ...
    app->Add(new JChainFactoryGeneratorT<TrackerHitReconstruction_factory>(
            {"TOFBarrelDigiHits"},    // Input data collection tags
