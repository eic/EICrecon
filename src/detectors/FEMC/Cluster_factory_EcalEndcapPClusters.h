...
class Association_factory_EcalEndcapPClusterAssociations : public JFactoryPodioTFixed<edm4eic::MCRecoClusterParticleAssociation> {
...
class Cluster_factory_EcalEndcapPClusters : public JFactoryPodioTFixed<edm4eic::Cluster>, CalorimeterClusterRecoCoG {
