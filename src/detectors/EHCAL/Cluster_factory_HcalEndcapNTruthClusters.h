...
class Cluster_factory_HcalEndcapNTruthClusters : public JMultifactory, CalorimeterClusterRecoCoG {

public:
    //------------------------------------------
    // Constructor
    Cluster_factory_HcalEndcapNTruthClusters(){
        DeclarePodioOutput<edm4eic::Cluster>("HcalEndcapNTruthClusters");
        DeclarePodioOutput<edm4eic::MCRecoClusterParticleAssociation>("HcalEndcapNTruthClusterAssociations");
    }
    ...
    void Init() override{
        ...
        m_log = app->GetService<Log_service>()->logger("HcalEndcapNTruthClusters");
    ...
    void Process(const std::shared_ptr<const JEvent> &event) override{
        ...
        SetData("HcalEndcapNTruthClusters", m_outputClusters);
        SetData("HcalEndcapNTruthClusterAssociations", m_outputAssociations);
