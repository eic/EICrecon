...
void InitPlugin(JApplication* app) {
  ...
  app->Add(new JOmniFactoryGeneratorT<CalorimeterClusterRecoCoG_factory>(
      ...
      {"HcalEndcapPInsertClustersWithoutShapes", "HcalEndcapPInsertClusterAssociationsWithoutShape"
  ...
  app->Add(new JOmniFactoryGeneratorT<CalorimeterClusterRecoCoG_factory>(
      ...
      {"LFHCALSplitMergeClustersWithoutShapes", "LFHCALSplitMergeClusterAssociationsWithoutShap"
