...
void InitPlugin(JApplication* app) {
  ...
  app->Add(new JOmniFactoryGeneratorT<ImagingTopoCluster_factory>(
      ...
      {"HcalEndcapPInsertImagingProtoClusters"},
      {
          ...
          .localDistXY          = {"0.5 * max(HcalEndcapPInsertCellSizeLGRight, HcalEndcapPInsertCellSizeLGLeft)",
                                   "0.5 * max(HcalEndcapPInsertCellSizeLGRight, HcalEndcapPInsertCellSizeLGLeft) * sin(pi / 3)"},
          .layerDistXY          = {"0.25 * max(HcalEndcapPInsertCellSizeLGRight, HcalEndcapPInsertCellSizeLGLeft)",
                                   "0.25 * max(HcalEndcapPInsertCellSizeLGRight, HcalEndcapPInsertCellSizeLGLeft) * sin(pi / 3)"},
