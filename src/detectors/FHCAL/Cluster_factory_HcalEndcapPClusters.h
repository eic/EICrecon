...
class Cluster_factory_HcalEndcapPClusters : public JMultifactory, CalorimeterClusterRecoCoG {

public:
    //------------------------------------------
    // Constructor
    Cluster_factory_HcalEndcapPClusters(){
        DeclarePodioOutput<edm4eic::Cluster>("HcalEndcapPClusters");
        DeclarePodioOutput<edm4eic::MCRecoClusterParticleAssociation>("HcalEndcapPClusterAssociations");
    }
    ...
    void Init() override{
        ...
        m_log = app->GetService<Log_service>()->logger("HcalEndcapPClusters");
        ...
        app->SetDefaultParameter("FHCAL:HcalEndcapPClusters:samplingFraction",             m_sampFrac);
        app->SetDefaultParameter("FHCAL:HcalEndcapPClusters:logWeightBase",  m_logWeightBase);
        app->SetDefaultParameter("FHCAL:HcalEndcapPClusters:depthCorrection",     m_depthCorrection);
        app->SetDefaultParameter("FHCAL:HcalEndcapPClusters:input_simhit_tag", m_input_simhit_tag);
        app->SetDefaultParameter("FHCAL:HcalEndcapPClusters:input_protoclust_tag", m_input_protoclust_tag);
        app->SetDefaultParameter("FHCAL:HcalEndcapPClusters:energyWeight",   m_energyWeight);
        app->SetDefaultParameter("FHCAL:HcalEndcapPClusters:moduleDimZName",   m_moduleDimZName);
        app->SetDefaultParameter("FHCAL:HcalEndcapPClusters:enableEtaBounds",   m_enableEtaBounds);
    ...
    void Process(const std::shared_ptr<const JEvent> &event) override{
        ...
        SetData("HcalEndcapPClusters", m_outputClusters);
        SetData("HcalEndcapPClusterAssociations", m_outputAssociations);
