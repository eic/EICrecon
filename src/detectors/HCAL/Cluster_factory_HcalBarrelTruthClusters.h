...
public:
    ...
    void Init() override{
        ...
        app->SetDefaultParameter("HCAL:HcalBarrelTruthClusters:samplingFraction",             m_sampFrac);
        app->SetDefaultParameter("HCAL:HcalBarrelTruthClusters:logWeightBase",  m_logWeightBase);
        app->SetDefaultParameter("HCAL:HcalBarrelTruthClusters:depthCorrection",     m_depthCorrection);
        app->SetDefaultParameter("HCAL:HcalBarrelTruthClusters:input_simhit_tag", m_input_simhit_tag);
        app->SetDefaultParameter("HCAL:HcalBarrelTruthClusters:input_protoclust_tag", m_input_protoclust_tag);
        app->SetDefaultParameter("HCAL:HcalBarrelTruthClusters:energyWeight",   m_energyWeight);
        app->SetDefaultParameter("HCAL:HcalBarrelTruthClusters:moduleDimZName",   m_moduleDimZName);
