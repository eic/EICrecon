...
class CalorimeterHit_factory_GFHCALMergedHits : public JFactoryT<edm4eic::CalorimeterHit>, CalorimeterHitsMerger {

public:
    //------------------------------------------
    // Constructor
    CalorimeterHit_factory_GFHCALMergedHits(){
        SetTag("GFHCALMergedHits");
    ...
    void Init() override{
        ...
        app->SetDefaultParameter("HCAL:GFHCALMergedHits:input_tag", m_input_tag);
        app->SetDefaultParameter("HCAL:GFHCALMergedHits:readout", m_readout);
        app->SetDefaultParameter("HCAL:GFHCALMergedHits:fields", u_fields);
        app->SetDefaultParameter("HCAL:GFHCALMergedHits:refs",  u_refs);
