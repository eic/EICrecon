...
public:
    ...
    void Init() override{
        ...
        app->SetDefaultParameter("HCAL:HcalEndcapPTruthClusters:samplingFraction",             m_sampFrac);
        app->SetDefaultParameter("HCAL:HcalEndcapPTruthClusters:logWeightBase",  m_logWeightBase);
        app->SetDefaultParameter("HCAL:HcalEndcapPTruthClusters:depthCorrection",     m_depthCorrection);
        app->SetDefaultParameter("HCAL:HcalEndcapPTruthClusters:input_simhit_tag", m_input_simhit_tag);
        app->SetDefaultParameter("HCAL:HcalEndcapPTruthClusters:input_protoclust_tag", m_input_protoclust_tag);
        app->SetDefaultParameter("HCAL:HcalEndcapPTruthClusters:energyWeight",   m_energyWeight);
        app->SetDefaultParameter("HCAL:HcalEndcapPTruthClusters:moduleDimZName",   m_moduleDimZName);
