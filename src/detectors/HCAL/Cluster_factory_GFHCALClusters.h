...
class Association_factory_GFHCALClustersAssociations : public JFactoryT<edm4eic::MCRecoClusterParticleAssociation> {

public:
    //------------------------------------------
    // Constructor
    Association_factory_GFHCALClustersAssociations(){
        SetTag("GFHCALClustersAssociations");
    }
};


class Cluster_factory_GFHCALClusters : public JFactoryT<edm4eic::Cluster>, CalorimeterClusterRecoCoG {

public:
    //------------------------------------------
    // Constructor
    Cluster_factory_GFHCALClusters(){
        SetTag("GFHCALClusters");
    ...
    void Init() override{
        ...
        m_input_protoclust_tag="GFHCALIslandProtoClusters";
        ...
        app->SetDefaultParameter("HCAL:GFHCALClusters:samplingFraction",             m_sampFrac);
        app->SetDefaultParameter("HCAL:GFHCALClusters:logWeightBase",  m_logWeightBase);
        app->SetDefaultParameter("HCAL:GFHCALClusters:depthCorrection",     m_depthCorrection);
        app->SetDefaultParameter("HCAL:GFHCALClusters:input_simhit_tag", m_input_simhit_tag);
        app->SetDefaultParameter("HCAL:GFHCALClusters:input_protoclust_tag", m_input_protoclust_tag);
        app->SetDefaultParameter("HCAL:GFHCALClusters:energyWeight",   m_energyWeight);
        app->SetDefaultParameter("HCAL:GFHCALClusters:moduleDimZName",   m_moduleDimZName);
        app->SetDefaultParameter("HCAL:GFHCALClusters:enableEtaBounds",   m_enableEtaBounds);
    ...
    void Process(const std::shared_ptr<const JEvent> &event) override{
        ...
        event->Insert(m_outputAssociations, "GFHCALClusterAssociations");
