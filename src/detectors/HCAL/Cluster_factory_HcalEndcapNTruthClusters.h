...
class Cluster_factory_HcalEndcapNTruthClusters : public JFactoryPodioTFixed<edm4eic::Cluster>, CalorimeterClusterRecoCoG {
...
public:
    ...
    void Init() override{
        ...
        app->SetDefaultParameter("HCAL:HcalEndcapNTruthClusters:samplingFraction",             m_sampFrac);
        app->SetDefaultParameter("HCAL:HcalEndcapNTruthClusters:logWeightBase",  m_logWeightBase);
        app->SetDefaultParameter("HCAL:HcalEndcapNTruthClusters:depthCorrection",     m_depthCorrection);
        app->SetDefaultParameter("HCAL:HcalEndcapNTruthClusters:input_simhit_tag", m_input_simhit_tag);
        app->SetDefaultParameter("HCAL:HcalEndcapNTruthClusters:input_protoclust_tag", m_input_protoclust_tag);
        app->SetDefaultParameter("HCAL:HcalEndcapNTruthClusters:energyWeight",   m_energyWeight);
        app->SetDefaultParameter("HCAL:HcalEndcapNTruthClusters:moduleDimZName",   m_moduleDimZName);
