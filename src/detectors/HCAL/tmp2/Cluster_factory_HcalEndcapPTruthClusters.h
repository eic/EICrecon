...
public:
    ...
    void Init() override{
        ...
        app->SetDefaultParameter("ZDC:HcalEndcapPTruthClusters:samplingFraction",             m_sampFrac);
        app->SetDefaultParameter("ZDC:HcalEndcapPTruthClusters:logWeightBase",  m_logWeightBase);
        app->SetDefaultParameter("ZDC:HcalEndcapPTruthClusters:depthCorrection",     m_depthCorrection);
        app->SetDefaultParameter("ZDC:HcalEndcapPTruthClusters:input_simhit_tag", m_input_simhit_tag);
        app->SetDefaultParameter("ZDC:HcalEndcapPTruthClusters:input_protoclust_tag", m_input_protoclust_tag);
        app->SetDefaultParameter("ZDC:HcalEndcapPTruthClusters:energyWeight",   m_energyWeight);
        app->SetDefaultParameter("ZDC:HcalEndcapPTruthClusters:moduleDimZName",   m_moduleDimZName);
        app->SetDefaultParameter("ZDC:HcalEndcapPTruthClusters:enableEtaBounds",   m_enableEtaBounds);
