...
class Association_factory_LFHCALTruthClustersAssociations : public JFactoryT<edm4eic::MCRecoClusterParticleAssociation> {
...
public:
    ...
    void Init() override{
        ...
        app->SetDefaultParameter("HCAL:LFHCALTruthClusters:samplingFraction",             m_sampFrac);
        app->SetDefaultParameter("HCAL:LFHCALTruthClusters:logWeightBase",  m_logWeightBase);
        app->SetDefaultParameter("HCAL:LFHCALTruthClusters:depthCorrection",     m_depthCorrection);
        app->SetDefaultParameter("HCAL:LFHCALTruthClusters:input_simhit_tag", m_input_simhit_tag);
        app->SetDefaultParameter("HCAL:LFHCALTruthClusters:input_protoclust_tag", m_input_protoclust_tag);
        app->SetDefaultParameter("HCAL:LFHCALTruthClusters:energyWeight",   m_energyWeight);
        app->SetDefaultParameter("HCAL:LFHCALTruthClusters:moduleDimZName",   m_moduleDimZName);
        app->SetDefaultParameter("HCAL:LFHCALTruthClusters:enableEtaBounds",   m_enableEtaBounds);
