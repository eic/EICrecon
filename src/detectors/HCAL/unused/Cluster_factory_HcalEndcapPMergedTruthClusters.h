...
class Cluster_factory_HcalEndcapPMergedTruthClusters : public JFactoryT<edm4eic::Cluster>, CalorimeterClusterMerger {

public:
    //------------------------------------------
    // Constructor
    Cluster_factory_HcalEndcapPMergedTruthClusters(){
        SetTag("HcalEndcapPMergedTruthClusters");
    }
    ...
    void Init() override{
        ...
        m_input_tag="HcalEndcapPTruthClusters";
        m_inputAssociations_tag="HcalEndcapPTruthClusterAssociations";
