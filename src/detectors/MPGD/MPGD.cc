...
void InitPlugin(JApplication* app) {
  ...
  app->Add(new JOmniFactoryGeneratorT<SiliconTrackerDigi_factory>(
      "MPGDBarrelRawHits", {"MPGDBarrelHits"}, {"MPGDBarrelRawHits"},
      {
  ...
  // Digitization
  app->Add(new JOmniFactoryGeneratorT<SiliconTrackerDigi_factory>(
      "MPGDDIRCRawHits", {"MPGDDIRCHits"}, {"MPGDDIRCRawHits"},
      {
          .threshold      = 0.25 * dd4hep::keV,
          .timeResolution = 10,
      },
  ...
  // Convert raw digitized hits into hits with geometry info (ready for tracking)
  app->Add(new JOmniFactoryGeneratorT<TrackerHitReconstruction_factory>(
      "MPGDDIRCRecHits", {"MPGDDIRCRawHits"}, // Input data collection tags
  ...
  // Digitization
  app->Add(new JOmniFactoryGeneratorT<SiliconTrackerDigi_factory>(
      "OuterMPGDBarrelRawHits", {"OuterMPGDBarrelHits"}, {"OuterMPGDBarrelRawHits"},
      {
          .threshold      = 0.25 * dd4hep::keV,
          .timeResolution = 10,
      },
  ...
  // Digitization
  app->Add(new JOmniFactoryGeneratorT<SiliconTrackerDigi_factory>(
      "BackwardMPGDEndcapRawHits", {"BackwardMPGDEndcapHits"}, {"BackwardMPGDEndcapRawHits"},
      {
          .threshold      = 0.25 * dd4hep::keV,
          .timeResolution = 10,
      },
  ...
  // Digitization
  app->Add(new JOmniFactoryGeneratorT<SiliconTrackerDigi_factory>(
      "ForwardMPGDEndcapRawHits", {"ForwardMPGDEndcapHits"}, {"ForwardMPGDEndcapRawHits"},
      {
          .threshold      = 0.25 * dd4hep::keV,
          .timeResolution = 10,
      },
