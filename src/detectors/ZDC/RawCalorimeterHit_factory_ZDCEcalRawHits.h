...
#ifndef _RawCalorimeterHit_factory_ZDCEcalRawHits_h_
#define _RawCalorimeterHit_factory_ZDCEcalRawHits_h_
...
#endif // _RawCalorimeterHit_factory_ZDCEcalRawHits_h_
