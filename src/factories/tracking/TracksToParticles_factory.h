...
extern template class JOmniFactory<eicrecon::TracksToParticles_factory, eicrecon::NoConfig>;
extern template class JOmniFactoryGeneratorT<eicrecon::TracksToParticles_factory>;
