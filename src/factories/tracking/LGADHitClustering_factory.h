...
extern template class JOmniFactory<eicrecon::LGADHitClustering_factory, eicrecon::LGADHitClusteringConfig>;
extern template class JOmniFactoryGeneratorT<eicrecon::LGADHitClustering_factory>;
