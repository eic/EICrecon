...
extern template class JOmniFactory<eicrecon::ActsTrackMerger_factory, eicrecon::NoConfig>;
extern template class JOmniFactoryGeneratorT<eicrecon::ActsTrackMerger_factory>;
