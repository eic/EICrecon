...
extern template class JOmniFactory<eicrecon::ActsToTracks_factory, eicrecon::NoConfig>;
extern template class JOmniFactoryGeneratorT<eicrecon::ActsToTracks_factory>;
