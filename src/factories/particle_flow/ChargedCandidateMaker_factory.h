...
extern template class JOmniFactory<eicrecon::ChargedCandidateMaker_factory, eicrecon::NoConfig>;
extern template class JOmniFactoryGeneratorT<eicrecon::ChargedCandidateMaker_factory>;
