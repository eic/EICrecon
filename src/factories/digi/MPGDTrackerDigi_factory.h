...
extern template class JOmniFactory<eicrecon::MPGDTrackerDigi_factory, eicrecon::MPGDTrackerDigiConfig>;
extern template class JOmniFactoryGeneratorT<eicrecon::MPGDTrackerDigi_factory>;
