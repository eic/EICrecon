...
#include "algorithms/onnx/ChargeSharingDigitizationML.h"
...
class ChargeSharingDigitizationML_factory : public JOmniFactory<ChargeSharingDigitizationML_factory, ChargeSharingDigitizationMLConfig> {

public:
    using AlgoT = eicrecon::ChargeSharingDigitizationML;
private:
