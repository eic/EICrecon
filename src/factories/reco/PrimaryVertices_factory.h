...
extern template class JOmniFactory<eicrecon::PrimaryVertices_factory, eicrecon::PrimaryVerticesConfig>;
extern template class JOmniFactoryGeneratorT<eicrecon::PrimaryVertices_factory>;
