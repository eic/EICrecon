...
extern template class JOmniFactory<eicrecon::ClustersToParticles_factory, eicrecon::ClustersToParticlesConfig>;
extern template class JOmniFactoryGeneratorT<eicrecon::ClustersToParticles_factory>;
