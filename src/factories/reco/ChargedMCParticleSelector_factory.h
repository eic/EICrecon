...
extern template class JOmniFactory<eicrecon::ChargedMCParticleSelector_factory, eicrecon::NoConfig>;
extern template class JOmniFactoryGeneratorT<eicrecon::ChargedMCParticleSelector_factory>;
