...
extern template class JOmniFactory<eicrecon::TransformBreitFrame_factory, eicrecon::NoConfig>;
extern template class JOmniFactoryGeneratorT<eicrecon::TransformBreitFrame_factory>;
