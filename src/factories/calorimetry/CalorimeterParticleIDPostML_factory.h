...
extern template class JOmniFactory<eicrecon::CalorimeterParticleIDPostML_factory, eicrecon::NoConfig>;
extern template class JOmniFactoryGeneratorT<eicrecon::CalorimeterParticleIDPostML_factory>;
