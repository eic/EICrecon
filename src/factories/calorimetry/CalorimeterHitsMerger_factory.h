...
extern template class JOmniFactory<eicrecon::CalorimeterHitsMerger_factory, eicrecon::CalorimeterHitsMergerConfig>;
extern template class JOmniFactoryGeneratorT<eicrecon::CalorimeterHitsMerger_factory>;
