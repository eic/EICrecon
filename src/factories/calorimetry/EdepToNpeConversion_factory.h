...
extern template class JOmniFactory<eicrecon::EdepToNpeConversion_factory, eicrecon::EdepToNpeConversionConfig>;
extern template class JOmniFactoryGeneratorT<eicrecon::EdepToNpeConversion_factory>;
