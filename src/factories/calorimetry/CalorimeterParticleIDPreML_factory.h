...
extern template class JOmniFactory<eicrecon::CalorimeterParticleIDPreML_factory, eicrecon::NoConfig>;
extern template class JOmniFactoryGeneratorT<eicrecon::CalorimeterParticleIDPreML_factory>;
