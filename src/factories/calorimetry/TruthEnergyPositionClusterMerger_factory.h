...
extern template class JOmniFactory<eicrecon::TruthEnergyPositionClusterMerger_factory, eicrecon::NoConfig>;
extern template class JOmniFactoryGeneratorT<eicrecon::TruthEnergyPositionClusterMerger_factory>;
