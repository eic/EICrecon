...
extern template class JOmniFactory<eicrecon::CalorimeterHitReco_factory, eicrecon::CalorimeterHitRecoConfig>;
extern template class JOmniFactoryGeneratorT<eicrecon::CalorimeterHitReco_factory>;
